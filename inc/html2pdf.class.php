...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
         ...
         */
        public function __construct($orientation = 'P', $format = 'A4', $langue='es', $unicode=true, $encoding='UTF-8', $marges = array(3, 5, 3, 0))
        {
...
'.$content.'
        ...
        protected function _listeGetLi()
        {
            ...
            switch($st)
            {
              ...
              case 'square':
                    return array('helvetica', true, chr(110));//zapfdingbats

                case 'circle':
                    return array('helvetica', true, chr(109));//zapfdingbats

                case 'disc':
                default:
                    return array('helvetica', true, chr(108)); //zapfdingbats
           }
        }
