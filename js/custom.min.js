$(function() {
  ...
  var e = function() {
    ...
    e < 1170 ? ($("body").addClass("mini-sidebar"), $(".mini-nav li.selected").addClass("cnt-none"), $("#togglebtn").hide()) : ($("body").removeClass("mini-sidebar"), $(".mini-nav > li.selected").removeClass("cnt-none"), $("#togglebtn").show()), e < 1549 ? ($("body").addClass("rmv-right-panel"), $(".right-side-toggle i").addClass("ti-arrow-left")) : ($("body").removeClass("rmv-right-panel"), $(".right-side-toggle i").removeClass("ti-arrow-left"));
    var i = (window.innerHeight > 0 ? window.innerHeight : this.screen.height) - 1;
    (i -= 55) < 1 && (i = 1), i > 55 && $(".page-wrapper").css("min-height", i + "px")
  };
  $(window).ready(e), $(window).on("resize", e), $(".mini-nav > li, #togglebtn").on("click", function() {
    ...
    $("body").hasClass("mini-sidebar") && ($(".mini-nav > li.selected").removeClass("cnt-none"), $("#togglebtn").show())
    ...
    $(e).on("click", "li a", function(e) {
      if ($(this).next().is(".sub-menu") && $(this).next().is(":visible")) $(this).next().slideUp(300, function() {
        ...
        i.find("ul:visible").slideUp(300).removeClass("menu-open"), $(this).next().slideDown(300, function() {
          $(this).next().addClass("menu-open"), i.find("li.active").removeClass("active"), $(this).parent("li").addClass("active")
        })
      }
    })
  }, $.sidemenu($(".sidebar-menu")), $("#togglebtn").on("click", function() {
  ...
  }), $(".mini-nav, .sidebar-menu, .right-side-panel, .message-center, .right-sidebar").perfectScrollbar(), $("body").trigger("resize"), $(".list-task li label").on("click", function() {
  ...
  var i, n = ["skin-default", "skin-green", "skin-red", "skin-blue", "skin-purple", "skin-megna", "skin-default-dark", "skin-green-dark", "skin-red-dark", "skin-blue-dark", "skin-purple-dark", "skin-megna-dark"];

  function t(e) {
    var i, t;
    return $.each(n, function(e) {
      $("body").removeClass(n[e])
    }), $("body").addClass(e), i = "skin", t = e, "undefined" != typeof Storage ? localStorage.setItem(i, t) : window.alert("Please use a modern browser to properly view this template!"), !1
  }(i = function(e) {
    if ("undefined" != typeof Storage) return localStorage.getItem(e);
    window.alert("Please use a modern browser to properly view this template!")
  }("skin")) && $.inArray(i, n) && t(i), $("[data-skin]").on("click", function(e) {
